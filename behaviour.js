...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0099").s().p("AvrPsQkDkEhhlFQg8jFAAjeQAAjdA8jEQBhlHEDkDQGgmgJLAAQJMAAGfGgQGhGgAAJLQAAJMmhGgQmfGfpMABQpLgBmgmfg");
	this.shape.setTransform(141.95,141.95);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(393.8,347.95,1,1,0,0,0,112,19.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(59).to({_off:false},0).to({alpha:1},10).wait(122).to({alpha:0},10).wait(1));

	// Layer_5_copy
	this.instance_1 = new lib.Symbol6();
	this.instance_1.setTransform(328.15,306.7,1,1,0,0,0,90.2,19.5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(59).to({_off:false},0).to({alpha:1},10).wait(122).to({alpha:0},10).wait(1));

	// Layer_5
	this.instance_2 = new lib.Symbol3();
	this.instance_2.setTransform(333.9,272.45,1,1,0,0,0,74.1,26.5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(59).to({_off:false},0).to({alpha:1},10).wait(122).to({alpha:0},10).wait(1));

	// Layer_4
	this.instance_3 = new lib.Symbol4();
	this.instance_3.setTransform(366.55,231.2,1,1,0,0,0,90.8,26.5);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(59).to({_off:false},0).to({alpha:1},10).wait(122).to({alpha:0},10).wait(1));

	// Layer_3
	this.instance_4 = new lib.Symbol5();
	this.instance_4.setTransform(335.8,184.35,1,1,0,0,0,73.9,55.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(59).to({_off:false},0).to({alpha:1},10).wait(122).to({alpha:0},10).wait(1));

	// Layer_2
	this.instance_5 = new lib.Symbol1();
	this.instance_5.setTransform(516.05,258.05,1,1,0,0,0,142,142);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({alpha:0.6484},24).to({x:375},18).to({scaleX:1.2607,scaleY:1.2607,x:388.2},17).wait(132).to({scaleX:1.2606,scaleY:1.2606},0).to({scaleX:1.2607,scaleY:1.2607,x:418.2,alpha:0},10).wait(1));

	// Layer_1
	this.instance_6 = new lib.Symbol2();
	this.instance_6.setTransform(182.1,258.05,1,1,0,0,0,142,142);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({alpha:0.8984},24).to({x:334.05},18).to({scaleX:1.2607,scaleY:1.2607,x:320.9},17).wait(132).to({scaleX:1.2606,scaleY:1.2606},0).to({scaleX:1.2607,scaleY:1.2607,x:290.9,alpha:0},10).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(390.1,329.1,267.9,107.89999999999998);
// library properties:
lib.properties = {
